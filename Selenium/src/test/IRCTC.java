...
public class IRCTC {
	public static void main(String[] args) throws IOException {
    	...
    	WebElement e1=driver.findElement(By.xpath(".//*[@id='irctcCaptchaIfNlpFails']/table[1]/tbody/tr/td[2]/input"));
    	WebDriverWait wait=new WebDriverWait(driver, 10);
    	wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irctcCaptchaIfNlpFails']/table[1]/tbody/tr/td[2]/input")));
    	e1.sendKeys(s.trim());
    	ocr.stopEngine();
	}
